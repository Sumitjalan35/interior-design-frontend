      ...
      <section id="portfolio-section" className="py-20 bg-charcoal-900 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-[#bfa074] to-[#fffbe6] drop-shadow-lg mb-2 font-serif uppercase">
              PORTFOLIO
            </h2>
    ...
    <section id="portfolio-section" className="py-20 bg-charcoal-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ease-out transform ${
          ...
          <h2
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-widest text-transparent bg-clip-text bg-gradient-to-b from-[#bfa074] to-[#fffbe6] drop-shadow-lg mb-2 font-serif uppercase"
            style={{ fontFamily: 'Playfair Display, serif', letterSpacing: '0.15em', textShadow: '0 4px 24px #bfa07499' }}
          >
            PORTFOLIO
          </h2>
          <div className="text-[#bfa074] text-xs tracking-widest font-light mb-6">LUXURY BEYOND BLUEPRINT</div>
